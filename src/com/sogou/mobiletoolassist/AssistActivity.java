...
//		});
	...
	static {
		...
		nameipMap.put("徐文静", "10.129.157.69 ");
		nameipMap.put("田丹丹", "10.129.156.198");
		nameipMap.put("谷晓沙", "10.129.158.21");
		nameipMap.put("廖振华", "10.129.156.103");
		nameipMap.put("王灿", "10.129.156.142");
		nameipMap.put("王坤", "10.129.158.46");
		nameipMap.put("董宏博", "10.129.157.240");
		nameipMap.put("孙静", "10.129.158.123");
		nameipMap.put("赵喜宁", "10.129.157.39");
		nameipMap.put("商丽丽", "");
		nameipMap.put("唐志刚", "10.129.158.20");
