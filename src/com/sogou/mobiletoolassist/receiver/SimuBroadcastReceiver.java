...
public class SimuBroadcastReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		//Notification nf = new Notification(R.drawable.ic_launcher,String.valueOf(System.currentTimeMillis()) , System.currentTimeMillis());
		Builder builder = new NotificationCompat.Builder(context);
		builder.setSmallIcon(R.drawable.ic_launcher).setOngoing(false)
				.setContentTitle("耗电量测试").setContentText("222");
		builder.setTicker(String.valueOf(System.currentTimeMillis()));
		NotificationManager nManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
		nManager.notify(345, builder.build());
