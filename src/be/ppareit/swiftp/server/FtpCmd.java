...
public abstract class FtpCmd implements Runnable {
    ...
    private static Class<?>[] allowedCmdsWhileAnonymous = {CmdSYST.class,
    	CmdUSER.class, CmdPASS.class, CmdTYPE.class, CmdCWD.class,
    	CmdPWD.class, CmdLIST.class, CmdPASV.class, CmdRETR.class,
    	CmdNLST.class, CmdNOOP.class, CmdSTOR.class, CmdDELE.class,
    	CmdRNFR.class, CmdRNTO.class, CmdRMD.class, CmdMKD.class,
    	CmdOPTS.class, CmdPORT.class, CmdQUIT.class, CmdFEAT.class,
    	CmdSIZE.class, CmdCDUP.class, CmdAPPE.class, CmdMDTM.class,
    	CmdMFMT.class, CmdREST.class, CmdSITE.class};
